...
export function MapIcon({ filled, className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      {filled ? (
        ...
        <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zM12 11.5a2.5 2.5 0 110-5 2.5 2.5 0 010 5z" strokeLinecap="round" strokeLinejoin="round" />
      )}
    </svg>
  )
}

export function LinkIcon({ filled, className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
