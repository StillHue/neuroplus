        ...
        <div className="px-5 pb-8 pt-3">
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2">
              <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#111111]">
                <Sparkles size={15} className="text-white" aria-hidden />
              </span>
              <span className="font-semibold text-[#111111]">neuroplus Premium</span>
            </div>
            <button
              onClick={handleClose}
              className="flex h-9 w-9 items-center justify-center rounded-full bg-[#F5F5F5] text-[#888888]"
              aria-label="Fechar"
            >
          ...
          <ul className="mb-6 flex flex-col gap-3">
            {PREMIUM_FEATURES.map(({ Icon, label }) => (
              <li key={label} className="flex items-center gap-3">
                <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#F5F5F5]">
                  <Icon size={14} className="text-[#111111]" aria-hidden />
                </span>
                <span className="text-sm text-[#111111]">{label}</span>
                <Check size={14} className="ml-auto text-[#111111]" aria-hidden />
              </li>
            ))}
          </ul>

          {/* Pricing */}
          <div className="mb-5 rounded-2xl border border-[#EBEBEB] bg-[#F9F9F9] px-4 py-4">
            <div className="flex items-end gap-1.5">
              <span className="text-3xl font-bold text-[#111111]">R$29</span>
              <span className="mb-1 text-sm text-[#888888]">/mês</span>
            </div>
            <p className="mt-0.5 text-xs text-[#888888]">Cancele quando quiser. Sem fidelidade.</p>
          </div>
          ...
          <p className="mt-3 text-center text-[11px] text-[#AAAAAA]">
