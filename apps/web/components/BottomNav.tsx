...
export function BottomNav({ badges = {} }: BottomNavProps) {
  ...
  return (
    ...
    >
      {/* White pill */}
      <div
        className="pointer-events-auto flex w-full max-w-[398px] items-center rounded-full bg-white shadow-nav px-2"
        style={{ height: "64px" }}
      >
                ...
                >
                  <span
                    ...
                    className={cn(
                      ...
                      active ? "bg-[#111111] text-white" : "text-[#AAAAAA]",
                    )}
                    style={{
                  ...
                  {badgeCount != null && badgeCount > 0 && (
                    <span
                      className="absolute right-2 top-1.5 flex h-[14px] min-w-[14px] items-center justify-center rounded-full bg-[#111111] px-0.5 text-[9px] font-bold leading-none text-white"
        ...
        <Link
          ...
          className="ml-2 mr-1 flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#111111] text-white shadow-fab transition-opacity active:opacity-80"
        >
